...
{
    internal class TestResultExecutedContext : ResultExecutedContext
    {
        private Exception _exception;
        private ExceptionDispatchInfo _exceptionDispatchInfo;

        public TestResultExecutedContext(
        ...
        public TestResultExecutedContext(ResultExecutingContext context)
            : this(context.ActionContext, context.Filters, context.Controller, context.Result)
        {
        }
        ...
        public override IActionResult Result { get; }
    }
}
